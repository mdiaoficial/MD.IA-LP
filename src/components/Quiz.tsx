...
function Result({ result, answers }: { result: QuizResult; answers: QuizAnswers }) {
  ...
  const whatsappMessage = encodeURIComponent(
    `Oi Dr. Daniel, fiz o diagnóstico no site.\n\nNota da minha clínica: ${result.score}/100\nPerda mensal estimada: ${formatBRL(result.monthlyLoss)}\n\nQuero conversar.`,
  );
        ...
        <div className="relative">
          ...
          <div className="mt-10 flex flex-col items-start gap-4 sm:flex-row sm:items-center">
            ...
            >
              ...
              Conversar com Dr. Daniel no WhatsApp
              <span className="text-xl transition-transform group-hover:translate-x-1">→</span>
            </a>
